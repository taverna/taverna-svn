...
public final class CommonKey {
	...
	protected static final PropertyKey LocalServiceCategoryKey = new StringKey("category");
	protected static final PropertyKey SoaplabCategoryKey = new StringKey("catgeory");
}
