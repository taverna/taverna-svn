...
/**
 * Servlet to handle interaction request submissions, all servlets
 * are stateless and rely on a singleton instance of the SubmissionServer
 * class to do the real work, this is just a presentation layer.
 * @author Tom Oinn
 */
public class SubmitServlet extends HttpServlet {
	...
	try {
		...
		jobID = server.createInteractionRequest(metadata,
							dataItem);
		log.debug("Submitted job to server, received ID '"+jobID+"'.");
	    }
	    else {
		throw new ServletException("Request must contain both data and metadata parts.");
	    }
	}
