...
public abstract class JNLPDocument extends org.jdom.Document {
    ...
    /**
     * Add the website address for information about this
     * application.
     */
    ...
    /**
     * Set the Code Base Location (URL)
     * where the JAR files of this JWS application reside 
     */
     ...
     * @param kind the description type - accepted values are "one-line", "short" and "tooltip"
     */
     ...
     * @param args all arguments sent as a string
     */
     ...
     * @param mainClass the class whose Main method will be executed
     */
    ...
    /**
     * Set the value of all-permissions, i.e. whether the application needs full access to
     * the users computer. Default is false. If true, an all-permissions element enclosed
     * in a security element must be created.
     * @param value true if the applications should request all permissions, false otherwise
     */
