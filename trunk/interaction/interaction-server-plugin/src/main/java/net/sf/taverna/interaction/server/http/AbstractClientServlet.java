...
/**
 * Superclass of the client upload / download servlets, takes care
 * of extracting the session ID, finding the state etc from the 
 * request object
 * @author Tom Oinn
 */
public abstract class AbstractClientServlet extends HttpServlet {
	...
	try {
		...
		throw new ServletException("Failure in handling POST request", ex);
	    }
	}
    }
