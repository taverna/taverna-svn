...
import org.biomoby.client.taverna.plugin.BioMobyObjectTreeCustomRenderer;
...
import uk.org.mygrid.dataplaygroundui.PlaygroundPanel;
	...
	public class PlaygroundBiomobyObjectAction extends AbstractProcessorAction {
		...
		public PlaygroundBiomobyObjectAction(boolean searchParentTypes) {
			super();
			this.searchParentTypes = searchParentTypes;
		}

		public PlaygroundBiomobyObjectAction(Port outputPort, boolean searchParentTypes) {
			super();
			this.searchParentTypes = searchParentTypes;
			this.outputPort = outputPort;
		}

		public PlaygroundBiomobyObjectAction() {
			super();
		}
		...
		private class Worker extends Thread {
			...
			private PlaygroundBiomobyObjectAction action;

			private JPanel panel = new JPanel(new BorderLayout());

			private JProgressBar bar = new JProgressBar();

			public Worker(BiomobyObjectProcessor bop, PlaygroundBiomobyObjectAction object) {
									...
									item.addActionListener(new ActionListener() {
										public void actionPerformed(ActionEvent ae) {
											...
											try {
												...
												playgroundPanel.addProcessor(point,(BiomobyProcessor)bpf);
