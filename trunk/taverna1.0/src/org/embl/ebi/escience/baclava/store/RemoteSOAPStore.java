 ...
 * provide data / metadata storage and LSID allocation
 * 
 * @author Tom Oinn
 */
public class RemoteSOAPStore implements BaclavaDataService, LSIDProvider {
	...
	public RemoteSOAPStore(Properties props) {
		String endpointString = props
				.getProperty("taverna.datastore.soap.endpoint");
		if (endpointString == null) {
			log
					.error("Property taverna.datastore.soap.endpoint is not defined, cannot\n"
