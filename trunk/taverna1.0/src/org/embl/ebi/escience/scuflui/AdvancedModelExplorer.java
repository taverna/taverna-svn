...
public class AdvancedModelExplorer extends JPanel 
	...
	try {
	    ...
	    worldIcon = c.getResource("openurl.gif");
	}
	catch (Exception e) {
	    //
	}
	...
	sb.append("This report applies to the workflow titled '<font color=\"red\">"+model.getDescription().getTitle()+"</font>' authored by '<font color=\"red\">"+model.getDescription().getAuthor()+"</font>' and with LSID '<font color=\"red\">"+model.getDescription().getLSID()+"</font>'. The textual description, if any is shown below :<blockquote><em>"+model.getDescription().getText()+"</em></blockquote>");
	...
	sb.append("<table border=\"1\" width=\"100%\" bgcolor=\"white\">");
	for (Iterator i = resources.keySet().iterator(); i.hasNext();) {
	    ...
	    sb.append("<tr><td valign=\"top\" bgcolor=\"#eeeeff\"colspan=\"3\"><img src=\""+worldIcon.toString()+"\"> <code><b>"+hostName+"</b></code></td></tr>\n");
		...
		sb.append("<tr>");
		sb.append("<td width=\"80\" valign=\"top\" rowspan=\""+rows+"\" bgcolor=\"#55bb22\">Web&nbsp;service</td>");
		sb.append("<td colspan=\"2\" bgcolor=\"#55bb22\">WSDL Defined at <font color=\"purple\">"+location+"</font></td>");
		sb.append("</tr>");
		...
		sb.append("<tr>");
		sb.append("<td width=\"80\" valign=\"top\" rowspan=\""+rows+"\" bgcolor=\"#ffff88\">Soaplab</td>");
		sb.append("<td colspan=\"2\" bgcolor=\"ffff88\">Service rooted at <font color=\"purple\">"+location+"</font></td>");
		sb.append("</tr>");
		...
		if (p instanceof WSDLBasedProcessor == false &&
		    ...
		    /**
		       ...
		       sb.append("<td bgcolor=\"#ffff88\">Soaplab</td>");
		       SoaplabProcessor sp = (SoaplabProcessor)p;
		       sb.append("<td>"+sp.getCategory()+"::<font color=\"purple\">"+sp.getAppName()+"</font></td>");
		       }
		    */
		    /**
		       else if (p instanceof WSDLBasedProcessor) {
		       sb.append("<td bgcolor=\"#55bb22\">Web&nbsp;service</td>");
		       ...
		       sb.append("<td><font color=\"purple\">"+targetOperation+"</font>&nbsp;in&nbsp;"+wsdl+"</td>");
		       }
		    */
		    if (p instanceof BiomobyProcessor) {
			sb.append("<td bgcolor=\"#ff9900\">Biomoby</td>");
