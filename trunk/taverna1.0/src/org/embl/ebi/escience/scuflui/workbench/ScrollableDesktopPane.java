 ...
 * scrollpane. It does this by calculating a preferred size which the
 * JDesktopPane doesnt really.
 * 
 * (PENDING)It could do with implementing a little more cleverly. At the moment
 * it validates a lot when unnecessary. The preferred should probably be
 * calculated in the ComponentListeners. It should probably also add an
 * InternalFrameListener also
 * 
 * 
 * Created: Fri Feb 19 15:08:09 1999
 * 
 * @author Phillip Lord
 * @version $Id: ScrollableDesktopPane.java,v 1.3 2004/10/01 13:38:20 mereden
 *          Exp $
 */
public class ScrollableDesktopPane extends JDesktopPane {
	...
	/**
	 * Remove an internal-frame from the desktop. Removes the component-listener
