...
public class DotViewTest {
	...
	public static void main(String args[]) throws Exception {
		...
		URL location = loader
				.getResource("org/embl/ebi/escience/scufl/view/test/complete_example_workflow.xml");
		...
		System.out
				.println("The dot file above can be rendered, assuming you have the dot binary, by putting it into a file and calling something like 'dot -Tgif < input.dot > output.gif'");
