...
/**
 * Port representing the output of a service, processor or workflow. In addition
 ...
 * finest grained entity that can be emited from that port. For example, if a
...
public interface OutputPort extends Port {
	 ...
	 * emited from this output port. A difference in this and the port depth
