 ...
 * activities.
 * <p>
 * A dispatch layer can receive a reference to the Queue and a set of Activities,
 * or a single Job and a set of Activities from the layer above it (or from the
...
public interface DispatchLayer<ConfigurationType> {
	...
	/**
	 * Receive a pointer to the job queue along with a set of activities, this is
	 ...
	 * activities has completed. Not all dispatch stack layers are compatible with
