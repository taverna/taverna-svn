 ...
 * -----------------------
 * Filename           $RCSfile: LogBookWebServiceTest.java,v $
...
public class LogBookWebServiceTest {

    private static final String LOG_BOOK_WEB_URL = "http://localhost:8080/logbook-service/services/LogBookWeb";

    private static final String workflowRunId = "urn:lsid:net.sf.taverna:wfInstance:cd8ec7d9-ee6e-4de6-8724-b8899cf11f12";
    ...
    public static void setUpClass() throws Exception {
        logBookWebService = new LogBookWebServiceLocator()
                .getLogBookWeb(new URL(LOG_BOOK_WEB_URL));
    }
    ...
    @Test
    public void testGetLogBookWebAddress() {
        String logBookWebAddress = new LogBookWebServiceLocator()
                .getLogBookWebAddress();
        assertEquals(LOG_BOOK_WEB_URL, logBookWebAddress);
    }

    @Test
    public void testGetLogBookWeb() throws AssertionFailedError,
            MalformedURLException, RemoteException {
        LogBookWebSoapBindingStub binding = bind();
        String workflowRun = binding.getWorkflowRun(workflowRunId);
        // System.out.println(workflowRun);
        assertNotNull("Retrieved workflowRun", workflowRun);
    }

    private LogBookWebSoapBindingStub bind() throws AssertionFailedError,
            MalformedURLException {
        LogBookWebSoapBindingStub binding;
        try {
            binding = (LogBookWebSoapBindingStub) new LogBookWebServiceLocator()
                    .getLogBookWeb();
        ...
        assertNotNull("Binding is not null", binding);
    ...
    public void testGetWorkflowOutputs() throws Exception {
        String[] outputs = logBookWebService
                .getWorkflowOutputs(aWorkflowRun);
    ...
    private void storeDisplayRemove(String rdfGraph, String graphName) throws RemoteException {
