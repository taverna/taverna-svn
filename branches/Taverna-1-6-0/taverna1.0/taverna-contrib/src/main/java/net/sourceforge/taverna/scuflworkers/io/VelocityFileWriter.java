...
/**
 * This class merges an input map of objects with a Velocity template and
 * outputs the results to an output file.
 * 
...
public class VelocityFileWriter implements LocalWorker {
	...
	public String[] inputNames() {
		return new String[] { "outputFile", "template" }; // TODO figure out
															// how to add a map
															// of values here.
	}
