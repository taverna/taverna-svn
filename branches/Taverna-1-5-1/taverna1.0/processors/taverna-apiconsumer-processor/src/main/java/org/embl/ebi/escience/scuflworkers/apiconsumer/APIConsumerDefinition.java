...
public class APIConsumerDefinition {
	...
	public APIConsumerDefinition(String className, String methodName,
		String[] pNames, String[] pTypes, int[] pDimensions, String tName,
		int tDimension, String description, boolean isConstructor,
		boolean isStatic) {
	...
	public APIConsumerDefinition(Element defElement) {
		...
		methodName = methodElement.getAttributeValue("name");
		isStatic =
			methodElement.getAttributeValue("static").equals("true");
		isConstructor =
			methodElement.getAttributeValue("constructor").equals("true");
		tName = methodElement.getAttributeValue("type");
		tDimension =
			Integer.parseInt(methodElement.getAttributeValue("dimension"));
		...
		pNames = new String[params.size()];
		pTypes = new String[params.size()];
		pDimensions = new int[params.size()];
		int count = 0;
		for (Iterator i = params.iterator(); i.hasNext();) {
			...
			pDimensions[count] =
				Integer.parseInt(parameterElement.getAttributeValue("dimension"));
			count++;
		}
	}
