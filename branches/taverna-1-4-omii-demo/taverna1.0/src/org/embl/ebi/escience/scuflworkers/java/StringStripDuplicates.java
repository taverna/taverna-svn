...
/**
 * Consumes a string list and emits the string list with duplicate entries
 * removed. The first occurance of a duplicate is preserved and all subsequent
 * ones omited, i.e the string list 'a,b,c,b,a,d' is converted to 'a,b,c,d'
 * 
 * @author Tom Oinn
 */
