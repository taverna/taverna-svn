 ...
 */
public class EnableWorkflowController extends SimpleFormController implements InitializingBean {
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
        ...
        workflowManager.enableWorkflow(Long.parseLong(workflowID.getId()));
