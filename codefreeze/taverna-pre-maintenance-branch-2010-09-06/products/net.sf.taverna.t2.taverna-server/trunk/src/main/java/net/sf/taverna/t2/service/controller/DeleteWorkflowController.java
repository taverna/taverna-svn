 ...
 */
public class DeleteWorkflowController extends SimpleFormController implements InitializingBean {
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
        ...
        workflowManager.deleteWorkflow(Long.parseLong(workflowID.getId()));
