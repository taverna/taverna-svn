 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.1 2008/11/28 17:31:48 anenadic Exp $
...
public abstract class InputHandler extends KeyAdapter
{
	...
	public static class clip_copy extends AbstractAction {
		...
		{
			super( "Copy" );
			putValue( Action.ACCELERATOR_KEY, getKeyStroke( "menu C" ));
		}
	...
	public static class clip_paste extends AbstractAction {
		...
		{
			super( "Paste" );
			putValue( Action.ACCELERATOR_KEY, getKeyStroke( "menu V" ));
		}
	...
	public static class clip_cut extends AbstractAction {
		...
		{
			super( "Cut" );
			putValue( Action.ACCELERATOR_KEY, getKeyStroke( "menu X" ));
		}
	...
	public static class undo extends AbstractAction {
		...
		{
			super( "Undo" );
			putValue( Action.ACCELERATOR_KEY, getKeyStroke( "menu Z" ));
		}
	...
	public static class redo extends AbstractAction {
		...
		{
			super( "Redo" );
			putValue( Action.ACCELERATOR_KEY, getKeyStroke( "menu Y" ));
		}
