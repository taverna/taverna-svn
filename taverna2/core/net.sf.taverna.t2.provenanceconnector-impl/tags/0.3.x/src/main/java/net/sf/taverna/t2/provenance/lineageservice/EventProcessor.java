...
public class EventProcessor {
	 ...
	 * 
	 */
	public EventProcessor(ProvenanceWriter pw, ProvenanceQuery pq) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		this.pw = pw;
		this.pq = pq;
...
//		System.out.println("incoming workflow structure:\n"+content);
		...
		try {
			...
			// TODO refactor this in light of new dataflow-instance distinction
			pw.addWFInstanceId(wfInstanceID, wfInstanceID);
...
//		URL resource = getClass().getClassLoader().getResource(TEST_EVENTS_FOLDER);
		File f1 = null;
