...
public class DerbyProvenance implements Provenance, SharedVocabulary {
	...
	public DerbyProvenance() throws InstantiationException,
			IllegalAccessException, ClassNotFoundException, SQLException {
		pw = new DerbyProvenanceWriter();
		...
		/*
		 * if (clearDB) { System.out.println("clearing DB"); pw.clearDB(); }
		 */
...
//			}
			...
			try {
				...
				System.out
						.println("Provenance: ************  processing event of type "
								+ SharedVocabulary.PROCESS_EVENT_TYPE);
			...
			System.out
					.println("Provenance: ************  end of workflow processing");
