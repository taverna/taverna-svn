...
public class ApiConsumerQueryFactory extends ActivityQueryFactory {

	@Override
	protected ActivityQuery createQuery(String property) {
		return new ApiConsumerQuery(property);
	}

	@Override
	protected String getPropertyKey() {
		return "taverna.defaultapiconsumer";
	}
	...
	public AddQueryActionHandler getAddQueryActionHandler() {
		return new ApiConsumerAddQueryActionHandler();
	}
