...
public class ApiConsumerPartitionAlgorithmSetSPI extends ActivityPartitionAlgorithmSet{
	...
	public ApiConsumerPartitionAlgorithmSetSPI() {
		partitionAlgorithms.add(new LiteralValuePartitionAlgorithm(API_NAME));
		partitionAlgorithms.add(new LiteralValuePartitionAlgorithm(API_CLASS));
		partitionAlgorithms.add(new LiteralValuePartitionAlgorithm(API_METHOD));
	}
}
