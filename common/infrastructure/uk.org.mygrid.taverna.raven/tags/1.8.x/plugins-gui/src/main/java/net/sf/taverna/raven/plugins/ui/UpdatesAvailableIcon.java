...
public class UpdatesAvailableIcon extends JLabel implements PluginManagerListener {
	...
	public static final Icon updateIcon = new ImageIcon(UpdatesAvailableIcon.class.getResource("update.png"));
	public static final Icon updateRecommendedIcon = new ImageIcon(UpdatesAvailableIcon.class.getResource("updateRecommended.png"));
