...
public class ApplicationRuntime {
	...
	private static final String RAVEN_VERSION = "1.9-SNAPSHOT";
	...
	public Set<Artifact> getSystemArtifacts() {
		...
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"raven-log4j", RAVEN_VERSION));
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"prelauncher", RAVEN_VERSION));
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"launcher", RAVEN_VERSION));
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"launcher-api", RAVEN_VERSION));
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"plugins-api", RAVEN_VERSION));
		artifacts.add(new BasicArtifact("uk.org.mygrid.taverna.raven",
				"appconfig", RAVEN_VERSION));
