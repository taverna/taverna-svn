...
import static net.sf.taverna.t2.platform.spring.RavenConstants.*;
 ...
 * <p>
 * Also defines the shorter specification form for the raven object driven from
 * a 'raven' element
 * 
 * @author Tom Oinn
 * 
...
public class ArtifactSupportNamespaceHandler extends NamespaceHandlerSupport {
	...
	public void init() {
		...
		registerBeanDefinitionParser("raven",
				new RepositoryBeanDefinitionParser());
		registerBeanDefinitionParser("pluginManager",
				new PluginManagerBeanDefinitionParser());
		registerBeanDefinitionParser("spi",
				new SPIRegistryBeanDefinitionParser());
