...
public class EFetchWorker extends AbstractEFetchWorker {
    ...
    public String[] inputNames() {
        return new String[]{"id","retstart","retmax","strand","seq_start","seq_stop","complexity","retmode","rettype",};
    }
    ...
    public String[] inputTypes() {
        return new String[]{"'text/plain'","'text/plain'","'text/plain'","'text/plain'","'text/plain'","'text/plain'","'text/plain'","'text/plain'","'text/plain'"};
    }
