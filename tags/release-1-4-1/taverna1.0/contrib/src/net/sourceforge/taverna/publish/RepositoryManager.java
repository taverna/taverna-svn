...
public class RepositoryManager {
     ...
     * @param repositoryClass  A fully qualified classname for the repository.
     * @return
     */ 
    ...
    /**
     * This method gets an instance of a repository based on the name
     * of the repository.
     ...
     * 
     * @param regex  The regular expression for the filename.
     * @return
     */
    ...
    /**
     * This method searches all repositories for a workflows with
    ...
    /**
     * This method searches for a repository given a specific filename regular expression.
     * @param repositoryName
     * @param fileRegex
     * @param startingDir
     * @param searchRecursively
     ...
     */
    public FileObject[] searchRepositoryByFileName(String repositoryName, String fileRegex, String startingDir, boolean searchRecursively) throws FileSystemException{
        FileObject[] filelist = null;
     ...
     * @throws FileSystemException
     */
    public FileObject[] searchRepositoryByAuthor(String repositoryName, String author, String startingDir, boolean searchRecursively ) throws FileSystemException{
        FileObject[] filelist = null;
        Repository rep = getInstance(repositoryName);
        FileObject root = fsManager.resolveFile( startingDir );
     ...
     * @throws FileSystemException
     */
    public FileObject[] searchRepositoryByDescription(String repositoryName, String startingDir, String description, boolean searchRecursively) throws FileSystemException{
        FileObject[] filelist = null;
        Repository rep = getInstance(repositoryName);        
        FileObject root = fsManager.resolveFile( startingDir );
