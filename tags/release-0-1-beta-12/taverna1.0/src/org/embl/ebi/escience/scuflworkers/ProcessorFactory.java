...
public abstract class ProcessorFactory {
     ...
     * in turn uses the XML handling code defined by
     * the XMLHandler and the fragment generated by
     * the getXMLFragment() method.
     */
    public final Processor createProcessor(String name, ScuflModel model)
