 ...
 * -----------------------
 * Filename           $RCSfile: DerbyDataService.java,v $
...
/**
 * Derby implementation of
 * {@link uk.org.mygrid.provenance.dataservice.AbstractJDBCDataService}.
 * 
 * @author Daniele Turi
 * @version $Id: DerbyDataService.java,v 1.1 2007-12-14 12:49:07 stain Exp $
 */
public class DerbyDataService extends AbstractJDBCDataService {

    static Logger log = Logger.getLogger(DerbyDataService.class.getName());
     ...
     */
    public DerbyDataService(Properties props) throws DataServiceException {
        super(props);
    }
    ...
    public void createTables() throws DataServiceException {
        ...
        try {
            ...
            st.executeUpdate("CREATE TABLE datathings "
                    + "(id INT NOT NULL GENERATED ALWAYS AS IDENTITY, "
                    + "thing LONG VARCHAR NOT NULL, PRIMARY KEY(id))");
            ...
            st
                    .executeUpdate("CREATE TABLE data (id INT NOT NULL GENERATED ALWAYS AS IDENTITY,"
                            + "                                       data CLOB NOT NULL,"
                            + "                                       PRIMARY KEY(id))");
    ...
    public String getDriver() {
        return ProvenanceConfigurator.DERBY_JDBC_DRIVER;
    }

    @Override
    public String getConnectionURL() throws DataServiceException {
        String connectionproperty = getConfiguration()
                .getProperty(ProvenanceConfigurator.DERBY_CONNECTION_URL);
        if (connectionproperty == null) {
            try {
                ProvenanceConfigurator
                        .missingPropertyMessage(ProvenanceConfigurator.DERBY_CONNECTION_URL);
    ...
    public String getUser() throws DataServiceException {
        String userProperty = getConfiguration()
                .getProperty(ProvenanceConfigurator.DERBY_USER);
        if (userProperty == null) {
            try {
                ProvenanceConfigurator
                        .missingPropertyMessage(ProvenanceConfigurator.DERBY_USER);
            } catch (PropertyMissingException e) {
                throw new DataServiceException(e);
            }
        }
    ...
    public String getPassword() {
        return getConfiguration().getProperty(ProvenanceConfigurator.DERBY_PASSWORD);
    }
