...
import uk.ac.man.cs.img.mygrid.provenance.knowledge.taverna.ProvenanceGeneratorException;
 ...
 * 
 */
public class LogBookReporter implements WorkflowEventListener {
    ...
    public static Logger logger = Logger.getLogger(LogBookReporter.class);

    private static LogBookReporter instance = null;
     ...
     * 
     * @return {@link LogBookReporter} instance.
     * @throws LogBookException 
     */
    public static LogBookReporter getInstance()
            throws LogBookException {
        if (instance == null) {
            new LogBookReporter();
        }
     ...
     * 
     * @throws ProvenanceGeneratorException if one instance already exists.
     */
    public LogBookReporter() throws LogBookException {
     ...
     * @throws ProvenanceGeneratorException if one instance already exists.
     */
    public LogBookReporter(Properties configuration)
