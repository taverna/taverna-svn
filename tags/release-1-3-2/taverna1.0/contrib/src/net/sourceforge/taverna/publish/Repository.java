...
/**
 * This interface defines the methods needed by a Repository implementation.  The Repository
 * represents anywhere that workflows, or data files may be stored.  A repository can be a network
 * file share, a WebDAV repository, or any other file system.
 * 
...
public interface Repository {
    ...
    /**
     * This method sets the name of the Repository.  This name
     * will appear in a list box of repository names, so keep it short.
     * @param name
     */
     ...
     * @param startingDir  The directory from which to start the search.  This should default to "/" the root directory.
     * @param regex        A regular expression that can be applied to each file.
     * @param srchRecursively  Indicates whether subdirectories should also be searched for files that match the regular expression
     ...
     * repository.
     * @param filelist	   The list of files to be written.
     * @param startingDir  The directory in which to deposit the files.  This
     * 					   directory is relative to the repository root directory.
