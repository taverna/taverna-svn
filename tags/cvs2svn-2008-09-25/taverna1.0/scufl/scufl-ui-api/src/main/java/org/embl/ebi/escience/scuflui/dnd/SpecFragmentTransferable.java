...
/**
 * This transferable data type encapsulates a SpecFragment object, and is used
 * for drag and drop of the processor spec fragments used to instantiate both
 * Processor and ProcessorFactory classes.
 * 
 * @author Tom Oinn
 */
public class SpecFragmentTransferable implements Transferable {
	...
	/**
	 * Construct a transferable directly from the spec element, using the
	 * constructor in the SpecFragment class to build the internal data
	 */
	...
	public boolean isDataFlavorSupported(DataFlavor flavor) {
		...
		if (this.data instanceof ProcessorSpecFragment
				&& flavor
						.equals(SpecFragmentTransferable.processorSpecFragmentFlavor)) {
			return true;
		}
		...
		if (this.data instanceof FactorySpecFragment
				&& flavor
						.equals(SpecFragmentTransferable.factorySpecFragmentFlavor)) {
			return true;
		}
