...
/**
 * A subclass of the EdgeRenderer which always routes edges with vertical normal vectors at the
 * control points.
 * 
 * @author Tom Oinn
 */
public class WorkflowEdgeRenderer extends EdgeRenderer
{
	...
	/**
	 * Sets the tension - at 1.0 the center point of each inter-point spline is horizontal, at 0.0
	 * it will be a direct line between the two points. At greater than 1.0 it will loop back, so
	...
	protected Shape createShape()
	{
		...
		if (n > 1)
		{
			...
			for (int i = 1; i < p.length; i++)
			{
				...
				view.sharedPath.curveTo(startX, startY + rowHeight, endX, endY - rowHeight, endX,
						endY);
			}
