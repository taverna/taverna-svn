...
public class OMIMWorkerTest extends AbstractXmlWorkerTest {
    ...
    public void testExecute() throws Exception{
        ...
        try {
        	...
        	if (e.getCause() instanceof TransmitterException) { //don't fail the test, there is something wrong with the external service not the worker.
        		logger.error("There is a problem with the http://www.ncbi.nlm.nih.gov/entrez/query.fcgi endpoint for OMIWorker");
        		return;
        	}
        	else {
        		throw e;
