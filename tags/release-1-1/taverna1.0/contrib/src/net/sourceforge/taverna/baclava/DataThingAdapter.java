...
/**
 * This class is designed as a wrapper for inputmaps and output maps.
 * Values that are typically stored in these maps are usually stored as
 * DataThings.  In order to make the code cleaner, this wrapper, insures
 * that values inserted into these maps are inserted as DataThings.
 * 
...
public class DataThingAdapter {
    ...
    /**
     * This method gets a value out of the map and returns it
     * as a string.  It performs the DataThing conversion for you.
     * @param key
     * @return
     */
    ...
    /**
     * This method wraps the string value in a DataThing before storing it
     * in the hashmap.
