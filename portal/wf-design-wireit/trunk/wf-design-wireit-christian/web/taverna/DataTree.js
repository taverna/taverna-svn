...
////--%>
//
////<% String imagesPath = response.encodeURL(request.getContextPath() + "/images/") ; %>
////var contextPath = "<%=request.getContextPath()%>";
////var imagesPath = "http://localhost:8080/wf-design-wireit-christian/taverna/images";
//var imagesPath = contextPath + "/taverna/images";
//
