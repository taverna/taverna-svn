...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.Comment.
 *
...
public class Comment extends Resource {
  ...
  public static Comment buildFromXML(Document doc) {
	...
	try {
	  ...
	  System.out.println("Found information for comment with ID: " + c.getID()
		  + ", URI: " + c.getURI());
	} catch (Exception e) {
            e.printStackTrace();
            System.out.println("Failed midway through creating comment object from XML " + e);
	}
