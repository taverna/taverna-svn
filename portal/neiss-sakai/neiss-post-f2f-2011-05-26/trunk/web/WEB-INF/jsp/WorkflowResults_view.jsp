...
<table class="jobs">
    ...
    for (int i=0; i< workflowSubmissionJobs.size(); i++ ) {
        String confirmDeletionText = "Are you sure you want to delete run "+ workflowSubmissionJobs.get(i).getUuid()+ "?";
...
%>
<p>Currently there are no workflows submitted for execution.</p>
<%
}
%>
