...
<form action="<portlet:actionURL/>" method="post">
<fieldset>
    <legend>Enter terms to search <a href="http://neiss.myexperiment.org" target="_blank" ><img style="vertical-align: middle;" src="<%=renderRequest.getContextPath()%>/images/myexperiment_logo_16x16.png" alt="myExperiment"></a> for workflows</legend>
