...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.File.
 *
  ...
  public static File buildFromXML(Element docRootElement) {
	...
	try {
	  ...
	  if (id == null || id.equals("")) {
		...
		System.out.println("Error while parsing file XML data - no ID provided for file with title: \""
	  ...
	  System.out.println("Found information for file with ID: " + f.getID()
		  + ", Title: " + f.getTitle());
	} catch (Exception e) {
            e.printStackTrace();
	  System.out.println("Failed midway through creating file object from XML " + e);
	}
