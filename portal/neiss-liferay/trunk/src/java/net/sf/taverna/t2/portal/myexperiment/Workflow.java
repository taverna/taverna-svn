...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.Workflow.
 * 
  ...
  public static Workflow buildFromXML(Element docRootElement) {
	...
	try {
	  ...
	  if (id == null || id.equals("")) {
		...
		System.out.println("Error while parsing workflow XML data - no ID provided for workflow with title: \""
	  ...
	  System.out.println("Found information for worklow with ID: " + w.getID()
		  + ", Title: " + w.getTitle());
	} catch (Exception e) {
            System.out.println("Failed midway through creating workflow object from XML " + e);
	    e.printStackTrace();
        }
