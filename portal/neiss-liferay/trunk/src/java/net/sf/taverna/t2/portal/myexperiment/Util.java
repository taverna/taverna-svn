...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.Util.
 * 
...
public class Util {
  ...
  private static final String BASE_RESOURCE_PATH = "/net/sf/taverna/t2/portal/myexperiment/";
  ...
  private static StyleSheet css = null;
  ...
  private static byte[] doEncryption(String str, int mode) {
	...
	try {
	  ...
	  return (encrypted);
            ...
            e.printStackTrace();
            System.out.println("Could not encrypt and store password " + e);
            return (new byte[1]);
	}
  ...
  public static URL getLocalResourceURL(String strResourceName) {
	String strResourcePath = BASE_RESOURCE_PATH;
	...
	return (Util.class.getResource(strResourcePath));
  }

  public static StyleSheet getStyleSheet(){
    if (css == null){
        css = new StyleSheet();
        css.importStyleSheet(getLocalResourceURL("css_stylesheet"));
    }
    return css;
  }
