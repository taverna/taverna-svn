...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.User.
 *
  ...
  public static User buildFromXML(Element docRootElement) {
	...
	try {
	  ...
	  user.favourites.addAll(Util.retrieveUserFavourites(docRootElement));
            ...
            e.printStackTrace();
            System.out.println("Failed midway through creating user object from XML");
	}
