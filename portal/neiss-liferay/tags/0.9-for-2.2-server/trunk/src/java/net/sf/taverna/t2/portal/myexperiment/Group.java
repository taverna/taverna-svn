...
/**
 * Adapted from net.sf.taverna.t2.ui.perspectives.myexperiment.model.Group.
 * 
  ...
  public static Group buildFromXML(Element docRootElement)
  {
    ...
    try {
      ...
      if (id == null || id.equals("")) {
        ...
        System.out.println("Error while parsing group XML data - no ID provided for group with title: \"" + docRootElement.getChildText("title") + "\"");
      }
      ...
      System.out.println("Found information for group with ID: " + g.getID() + ", Title: " + g.getTitle());
    }
    catch (Exception e) {
        System.out.println("Failed midway through creating group object from XML.");
        e.printStackTrace();
    }
