...
public class RshellInputViewer extends JPanel {
	 ...
	 * @param list 
	 */
	public RshellInputViewer(ActivityInputPortDefinitionBean bean,
	...
	private void initView() {
		...
		for (RShellPortSymanticTypeBean inputType : list) {
			if (bean.getName().equalsIgnoreCase(inputType.getName())) {
				semanticTypeSelector.setSelectedItem(inputType.getSymanticType());
				break;
			}
		}
		
		outerConstraint.gridx = 1;
		add(semanticTypeSelector, outerConstraint);
...
//				.getSimpleName());
	 ...
	 * @return
	 */
	public JComboBox getSemanticSelector() {
	...
	/**
	 * Sets the {@link #nameField}, {@link #semanticTypeSelector} and
	 * {@link #depthSpinner} to allow editing
	 */
	public void setEditMode() {
		this.nameField.setEditable(editable);
		this.semanticTypeSelector.setEnabled(editable);
