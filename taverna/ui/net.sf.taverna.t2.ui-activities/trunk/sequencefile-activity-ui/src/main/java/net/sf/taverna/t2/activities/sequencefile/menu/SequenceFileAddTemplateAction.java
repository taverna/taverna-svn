...
/**
 * A contextual menu action to add a SequenceFileActivity and a wrapping
 * processor to the workflow.
 * 
 * @author David Withers
 */
@SuppressWarnings("serial")
public class SequenceFileAddTemplateAction extends AbstractContextualMenuAction {

	private static final URI insertSection = URI
			.create("http://taverna.sf.net/2009/contextMenu/insert");

	public SequenceFileAddTemplateAction() {
	...
	protected Action createAction() {
		...
		AbstractAction action = new AbstractAction(SequenceFileTemplateService.SERVICE_NAME,
				ActivityIconManager.getInstance().iconForActivity(new SequenceFileActivity())) {
