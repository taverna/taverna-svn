...
import info.ipaw.pc3.PSLoadWorkflow.CSVFileEntry;
 ...
 *
 */
public class CSVFileEntryValueExtractor implements DataValueExtractor {
...
//	    System.out.println("extractString: decoded object of type "+o.getClass().getName());
	    
	    CSVFileEntry output = (CSVFileEntry) o; 
	    decoder.close(); 
