...
/**
 * Returns a {@link DerbyConfigView} if the view required is for a
 * {@link DerbyProvenanceConnector}
 * 
 * @author Ian Dunlop
 * 
 */
public class DerbyProvenanceConfigViewFactory implements
		ContextualViewFactory<DerbyProvenanceConnector> {
