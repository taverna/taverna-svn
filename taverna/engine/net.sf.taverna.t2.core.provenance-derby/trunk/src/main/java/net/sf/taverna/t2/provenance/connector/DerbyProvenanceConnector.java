...
public class DerbyProvenanceConnector extends ProvenanceConnector {
    ...
    private static final String createTableProcBinding = "CREATE TABLE ProcBinding (" + "pnameRef varchar(100) NOT NULL ," + "execIDRef varchar(100) NOT NULL ," + "actName varchar(100) NOT NULL ," + "iteration char(10) NOT NULL default ''," + "wfNameRef varchar(100)," +"PRIMARY KEY (pnameRef,execIDRef,iteration))";
