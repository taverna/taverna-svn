...
public class DerbyProvenanceConnector extends ProvenanceConnector {
    ...
    private static final String createTableWorkflow = "CREATE TABLE Workflow (" + "wfname varchar(100) NOT NULL," + "parentWFname varchar(100)," + "externalName varchar(100)," + "dataflow blob, "+ "PRIMARY KEY  (wfname))";
