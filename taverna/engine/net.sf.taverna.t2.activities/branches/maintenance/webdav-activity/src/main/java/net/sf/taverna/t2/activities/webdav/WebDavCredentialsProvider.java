package net.sf.taverna.t2.activities.webdav;
 ...
 * 
 * Copied from the rest-activity (which we can't depend on because sardine
 * needs a newer Apache HTTP client)
 * 
 * @author Sergejs Aleksejevs
 * @author Alex Nenadic
 * @author Stian Soiland-Reyes
 */
public class WebDavCredentialsProvider extends BasicCredentialsProvider
{
  private static Logger logger = Logger.getLogger(WebDavCredentialsProvider.class);
  ...
  private static class Singleton {
	  static WebDavCredentialsProvider instance = new WebDavCredentialsProvider();
  }
   ...
   */
  public static WebDavCredentialsProvider getInstance() {
