 ...
 */
public class DisableWorkflowController extends SimpleFormController implements InitializingBean {
	...
	protected ModelAndView onSubmit(HttpServletRequest request,
		...
		Identifier workflowID = (Identifier) command;

        workflowManager.disableWorkflow(Long.parseLong(workflowID.getId()));
