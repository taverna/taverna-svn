 ...
 * lines of text.
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.1 2008/11/28 17:31:48 anenadic Exp $
 */
@SuppressWarnings("serial")
public class TextAreaPainter extends JComponent implements TabExpander
{
	private static Logger logger = Logger.getLogger(TextAreaPainter.class);
	...
	public void paint(Graphics gfx)
	{
		...
		{
			logger.error("Error repainting line"
					+ " range {" + firstInvalid + ","
					+ lastInvalid + "}:",  e );
		}
	}
