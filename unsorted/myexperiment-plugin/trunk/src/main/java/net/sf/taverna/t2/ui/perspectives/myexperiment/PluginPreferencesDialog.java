...
public class PluginPreferencesDialog extends JDialog implements ComponentListener, ActionListener
{
  ...
  private void initialiseUI()
  {
    ...
    jpApiLocation.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " myExperiment Location "),
    ...
    jpStartupTabChoice.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " Plugin Start-up Settings "),
        BorderFactory.createEmptyBorder(0, 5, 5, 5)
    ));
    ...
    jpMyStuffPrefs.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " 'My Stuff' Tab Settings "),
        BorderFactory.createEmptyBorder(0, 5, 5, 5)
    ));
    ...
    jpPrivacySettings.setBorder(BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), " Privacy Settings "),
  ...
  public void actionPerformed(ActionEvent e)
  {
    if (e.getSource().equals(this.bSave))
    {
      ...
      if (strNewMyExperimentURL.length() == 0) {
        javax.swing.JOptionPane.showMessageDialog(null, "Please specify a base URL of myExperiment instance that you wish to connect to",
      ...
      {
        javax.swing.JOptionPane.showMessageDialog(null, "Please choose at least one section to display in 'My Stuff' tab",
            "Error", JOptionPane.WARNING_MESSAGE);
      ...
      if (!strNewMyExperimentURL.equals(myExperimentClient.getBaseURL()))
      {
        ...
        javax.swing.JOptionPane.showMessageDialog(null, "You have selected a new Base URL for myExperiment. "
            ...
            + "Auto-login feature has been switched off for you to check the login details at the next launch.", 
            "myExperiment Plugin - Info", JOptionPane.INFORMATION_MESSAGE);
      }
