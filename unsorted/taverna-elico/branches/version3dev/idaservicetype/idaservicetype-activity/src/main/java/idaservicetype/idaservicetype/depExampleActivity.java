...
public class depExampleActivity extends
		AbstractAsynchronousActivity<IDAActivityConfigurationBean>
		implements AsynchronousActivity<IDAActivityConfigurationBean> {
	...
	private IDAActivityConfigurationBean configBean;

	@Override
	public void configure(IDAActivityConfigurationBean configBean)
