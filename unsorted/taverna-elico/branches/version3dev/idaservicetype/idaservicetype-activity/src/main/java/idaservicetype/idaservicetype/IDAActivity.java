 ...
 * @author 
 */
public class IDAActivity extends
		AbstractAsynchronousActivity<IDAActivityConfigurationBean> implements NestedDataflow {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger
			.getLogger(IDAActivity.class);

	private Edits edits = EditsRegistry.getEdits();

	private Dataflow dataflow;
	private IDAActivityConfigurationBean bean;
	
	public void configure(IDAActivityConfigurationBean bean)
			throws ActivityConfigurationException {
		this.bean = bean;
		this.dataflow=bean.getDataflow();
	...
	@Override
	public IDAActivityConfigurationBean getConfiguration() {
		return bean;
	}
