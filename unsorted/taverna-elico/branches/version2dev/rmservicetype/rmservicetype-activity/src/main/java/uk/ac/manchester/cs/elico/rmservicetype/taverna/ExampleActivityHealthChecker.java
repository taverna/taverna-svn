...
public class ExampleActivityHealthChecker implements
		HealthChecker<RapidMinerExampleActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof RapidMinerExampleActivity;
	}
	...
	public VisitReport visit(RapidMinerExampleActivity activity, List<Object> ancestry) {
		RapidMinerActivityConfigurationBean config = activity.getConfiguration();
