...
public class ParameterTableModel extends AbstractTableModel {
	...
	public ParameterTableModel(List<RapidMinerParameterDescription> parameterDescriptions) {
		...
		data = new Object[parameterCount][7];
				...
				for (int n = 0; n < 7; n++) {
					...
					switch (n) {
		            	...
		            	case 2:	 data[i][n] = currentParam.getDescription(); 
				            	 break;											// desc
		            	case 3:  data[i][n] = currentParam.getMin();			// min
		            			 ...
		            			 break;											
		            	case 4:	 data[i][n] = currentParam.getMax();			// max
		            			 ...
		            			 break;											
		            	case 5:  data[i][n] = currentParam.getDefaultValue();
		            			 if (data[i][n].equals("?")) {
		            				 data[i][n] = "";
		            			 }
		            			 break;											// default val
		            	case 6:  data[i][n] = currentParam.getExecutionValue();
		            			 if (data[i][n].equals("?")) {
		            				 data[i][n] = "";
		            			 }
		            			 break;											// value
