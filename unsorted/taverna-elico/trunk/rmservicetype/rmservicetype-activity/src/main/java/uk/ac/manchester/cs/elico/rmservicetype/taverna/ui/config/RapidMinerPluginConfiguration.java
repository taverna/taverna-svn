...
public class RapidMinerPluginConfiguration extends AbstractConfigurable {
	...
	public static final String RA_REPOSITORY_LOCATION = "default_repository_location";

	public static final String FL_LOCATION = "fl_default_location";

	public static final String FL_TEMPDIR = "fl_temp_dir";
