...
public class TavernaWorkbenchWithExamplePlugin {
	public static void main(String[] args) throws Exception {
		...
		System.setProperty("raven.launcher.app.name", "taverna-2.4.0-Sardine-SNAPSHOT");
		System.setProperty("raven.launcher.app.title", "Taverna Workbench 2.4.0-Sardine-SNAPSHOT");
		Launcher.main(args);
	}
}
