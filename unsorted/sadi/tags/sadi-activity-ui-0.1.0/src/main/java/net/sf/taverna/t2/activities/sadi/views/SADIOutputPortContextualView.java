 ...
 */
public class SADIOutputPortContextualView extends ContextualView {

	private static final long serialVersionUID = 1L;
	
	private final SADIActivityOutputPort outputPort;
	private JPanel viewPanel;

	/**
	 * Constructs a new SADIOutputPortContextualView.
	 * @param outputPort
	 */
	public SADIOutputPortContextualView(SADIActivityOutputPort outputPort) {
	...
	public String getViewTitle() {
		return "SADI output : " + outputPort.getName();
	}
	...
	public void refreshView() {
		...
		OntClass rangeClass  = outputPort.getOntClass();
		c.insets = new Insets(5, 5, 5, 5);
		viewPanel.add(new JLabel(rangeClass.getLocalName()), c);
		
		for (RDFNode comment : rangeClass.listComments(null).toList()) {
