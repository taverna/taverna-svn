 ...
 */
public class SADIOutputPortContextualViewFactory implements ContextualViewFactory<SADIActivityOutputPort> {
	...
	public boolean canHandle(Object selection) {
		return selection instanceof SADIActivityOutputPort;
	}

	/* (non-Javadoc)
	 * @see net.sf.taverna.t2.workbench.ui.views.contextualviews.activity.ContextualViewFactory#getViews(java.lang.Object)
	 */
	public List<ContextualView> getViews(SADIActivityOutputPort outputPort) {
		return Arrays.asList(new ContextualView[] {new SADIOutputPortContextualView(outputPort)});
	}
