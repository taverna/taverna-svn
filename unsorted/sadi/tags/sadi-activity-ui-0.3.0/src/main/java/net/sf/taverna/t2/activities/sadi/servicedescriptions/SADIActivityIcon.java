...
/**
 * Provides the icon for the {@link SADIActivity}.
 *
 * @author David Withers
 */
public class SADIActivityIcon implements ActivityIconSPI {

	private static final Color COLOUR = Color.decode("#a3c88d");
	...
	public int canProvideIconScore(Activity<?> activity) {
		if (activity == null) {
			return NO_ICON;
		} else if (activity.getClass().getName().equals(SADIActivity.class.getName())) {
