...
class Base64 {
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new Base64.OutputStream(new FileOutputStream(filename),
					ENCODE);
	...
	public static byte[] decodeFromFile(String filename) {
		...
		try {
			...
			// Open a stream
			bis = new Base64.InputStream(new BufferedInputStream(
	...
	public static boolean encodeFileToFile(String infile, String outfile) {
		...
		try {
			in = new Base64.InputStream(new BufferedInputStream(
					new FileInputStream(infile)), ENCODE);
	...
	public static boolean decodeFileToFile(String infile, String outfile) {
		...
		try {
			in = new Base64.InputStream(new BufferedInputStream(
					new FileInputStream(infile)), DECODE);
