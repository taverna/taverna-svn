...
public class ComponentProfileImportMenuAction extends AbstractMenuAction {
	...
	private static final URI COMPONENT_PROFILE_IMPORT_URI = URI.create("http://taverna.sf.net/2008/t2workbench/menu#componentProfileImport");
	
	private static Action profileImportAction = new ComponentProfileImportAction();
	
	public ComponentProfileImportMenuAction() {
		super(ComponentProfileMenuSection.COMPONENT_PROFILE_SECTION, 200, COMPONENT_PROFILE_IMPORT_URI);
	}
