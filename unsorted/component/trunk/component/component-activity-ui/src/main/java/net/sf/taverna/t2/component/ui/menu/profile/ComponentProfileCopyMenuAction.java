...
public class ComponentProfileCopyMenuAction extends AbstractMenuAction {
	...
	private static final URI COMPONENT_PROFILE_COPY_URI = URI.create("http://taverna.sf.net/2008/t2workbench/menu#componentProfileCopy");
	
	private static Action profileCopyAction = new ComponentProfileCopyAction();
	
	public ComponentProfileCopyMenuAction() {
		super(ComponentProfileMenuSection.COMPONENT_PROFILE_SECTION, 250, COMPONENT_PROFILE_COPY_URI);
	}
