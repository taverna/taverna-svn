...
public class ComponentProfileDeleteMenuAction extends AbstractMenuAction {
	...
	private static final URI COMPONENT_PROFILE_DELETE_URI = URI.create("http://taverna.sf.net/2008/t2workbench/menu#componentProfileDelete");
	
	private static Action profileDeleteAction = new ComponentProfileDeleteAction();
	
	public ComponentProfileDeleteMenuAction() {
		super(ComponentProfileMenuSection.COMPONENT_PROFILE_SECTION, 300, COMPONENT_PROFILE_DELETE_URI);
	}
