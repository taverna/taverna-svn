...
public class ComponentProfileMenuSection extends AbstractMenuSection {
	...
	public static final URI COMPONENT_PROFILE_SECTION = URI.create("http://taverna.sf.net/2008/t2workbench/menu#componentProfileSection");
	
	public ComponentProfileMenuSection() {
		super(ComponentMenu.COMPONENT, 200 , COMPONENT_PROFILE_SECTION);
	}
