...
public class ComponentExceptionFactory {
	...
	public static ComponentException createComponentException(String exceptionId, String message) {
		ComponentException result = new ComponentException(message);
		result.setExceptionId(exceptionId);
		return result;
	}
	
	public static ComponentException createUnexpectedComponentException(String message) {
