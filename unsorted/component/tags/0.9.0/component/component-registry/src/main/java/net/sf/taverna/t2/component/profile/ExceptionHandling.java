...
public class ExceptionHandling {
	...
	public List<HandleException> getHandleExceptions() {
		if (handleExceptions.isEmpty() && !proxied.getHandleException().isEmpty()) {
			for (uk.org.taverna.ns._2012.component.profile.HandleException he : 
				proxied.getHandleException()) {
