...
public class UseCaseActivityContextualView extends HTMLBasedActivityContextualView<UseCaseActivityConfigurationBean> {
	...
	public UseCaseActivityContextualView(Activity<?> activity) {
		super(activity);
	}

	@Override
	protected String getRawTableRowsHtml() {
		String html = "<b>Usecase: </b>" + getConfigBean().getUsecaseid();
		return html;
	}
	...
	public Action getConfigureAction(final Frame owner) {
		return new UseCaseActivityConfigureAction((UseCaseActivity) getActivity(), owner);
	}
