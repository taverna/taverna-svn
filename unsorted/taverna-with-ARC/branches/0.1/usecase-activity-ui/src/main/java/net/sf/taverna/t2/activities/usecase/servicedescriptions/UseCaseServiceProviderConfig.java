...
public class UseCaseServiceProviderConfig extends PropertyAnnotated {
	...
	public UseCaseServiceProviderConfig() {
	}

	public UseCaseServiceProviderConfig(String repositoryUrl) {
		this.repositoryUrl = repositoryUrl;
	}

	@PropertyAnnotation(displayName = "UseCase repository location", preferred = true)
