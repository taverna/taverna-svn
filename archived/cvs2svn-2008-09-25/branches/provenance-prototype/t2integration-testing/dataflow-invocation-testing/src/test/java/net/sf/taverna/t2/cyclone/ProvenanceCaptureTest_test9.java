 ...
 * 
 */
public class ProvenanceCaptureTest_test9 extends TranslatorTestHelper {
	

	@Test
	public void testProvenanceCapture_test7() throws Exception {
		
		String scuflFile = "provenance-testing/test9.xml";
		...
		for (DataflowInputPort port : dataflow.getInputPorts()) {
			...
			if (port.getName().equals("I2")) {
				WorkflowDataToken inputToken1 = new WorkflowDataToken("",new int[]{}, entityId2, context);
				facade.pushData(inputToken1, port.getName());
			}
		}
