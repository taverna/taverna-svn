 ...
 * 
 */
public class ProvenanceCaptureTest_test9 extends InvocationTestHelper {
	

	@Test
	public void testProvenanceCapture_test6() throws Exception {
		
		String T2File = "provenance-testing/test9.xml";
		...
		T2Reference entityId2 = context.getReferenceService().register(i2, 0,
				true, context);
