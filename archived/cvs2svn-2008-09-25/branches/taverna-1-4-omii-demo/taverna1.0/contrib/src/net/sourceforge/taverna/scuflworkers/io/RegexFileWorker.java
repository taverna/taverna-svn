...
/**
 * This processor reads the text from a file,
 * and replaces all instances of the oldText with instances of the new text.
 * Use either the inputFile or the inputText parameter.  Note that the oldText
 * array and the newText array must be the same length.
 * 
