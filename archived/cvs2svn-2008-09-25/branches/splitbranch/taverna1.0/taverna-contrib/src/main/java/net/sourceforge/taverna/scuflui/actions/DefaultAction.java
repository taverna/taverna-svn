...
public abstract class DefaultAction extends AbstractAction {
	...
	/**
	 * This constructor is used whenever there is an action that needs to be
	 * wrapped with different icons and labels. This is useful when you want to
	 * take one of the EditorKit actions and customise them.
	 * 
	 * @param act
	 *            The action that you want to wrap.
	 */
	 ...
	 * @param _iconUrl
	 *            The relative URL for the small icon used by the action. This
	 *            icon will be loaded via the classpath and must be relative to
	 *            the classpath.
	 * @param _longDesc
	 *            The long description for the action
	 * @param _shortDesc
	 *            The short description for the action
	 */
	public DefaultAction(String _name, String _iconUrl, String _longDesc, String _shortDesc) {
		setName(_name);
	 ...
	 *            the classpath.
	 * @param _lrgIconUrl
	 *            The relative URL for the large icon used by the action. This
	 *            icon will be loaded via the classpath and must be relative to
	 *            the classpath.
	 * @param _longDesc
	 *            The long description for the action
	 ...
	 *            The short description for the action
	 */
	public DefaultAction(String _name, String _smallIconUrl, String _lrgIconUrl, String _longDesc, String _shortDesc) {
	 ...
	 *            String
	 */
	public void init(String _name, String _smallIconUrl, String _lrgIconUrl, String _longDesc, String _shortDesc) {
		setName(_name);
	 ...
	 * 
	 * @param _desc
	 *            A short description for the action, used for tooltip text.
	 */
	...
	/**
	 * This method sets the keystroke to be used as an accelerator for the
	 * action.
	 * 
	 * @param keystroke
	 *            The keystroke to be used as an accelerator for the action.
	 */
	 ...
	 * 
	 * @param lrgIconUrl
	 *            A string containing a path similar to "etc/myicon.png". The
	 *            etc directory must be part of the classpath in order for the
	 *            icon to be found.
	 */
	...
	/**
	 * This method executes each of the action listeners that have been added to
	 * it.
	 * 
	 * @param evt
	 *            ActionEvent
	...
	/**
	 * This method is used to get an action that from a list of predefined
	 * actions. This is used when you're wrapping an action with a new action.
	 * 
	 * @param actionConstant
	 *            The key used to identify the action.
	 * @param edKit
	 *            The editor kit where the action is located.
	 * @return
	 */
	protected Action getAction(String actionConstant, EditorKit edKit) {
		...
		if (action == null) {
			logger.info("Action: " + actionConstant + " was null");
	 ...
	 * 
	 * @param keychar
	 *            The key character to be used to invoke the action.
	 * @return
	 */
	...
	// protected static final String IMAGE_HOME =
	// System.getProperty("image.home");
