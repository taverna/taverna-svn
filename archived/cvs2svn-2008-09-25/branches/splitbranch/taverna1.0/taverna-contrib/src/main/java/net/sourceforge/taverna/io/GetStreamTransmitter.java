...
public class GetStreamTransmitter extends AbstractStreamTransmitter {
	...
	private static Logger logger = Logger.getLogger(GetStreamTransmitter.class);

	/**
	 * @see net.sourceforge.taverna.io.StreamTransmitter#transmit(java.util.Map,
	 ...
	 * 
	 * @param reflector
	 *            The reflector containing the data to be sent.
	 * @return
	 * @throws TransmitterException
	 *             If the URL length exceeds 256 chars.
	 * @throws IllegalArgumentException
	 *             if the reflector was null or contained no values.
	 */
	protected String makeUrl(Map map) throws TransmitterException {

		if ((map == null) || map.isEmpty()) {
			throw new IllegalArgumentException("The reflector was null or there were no parameters in it.");
		}
