 ...
 */
public class SaveWorkflowAsAction extends DefaultAction {

	private static final String ACTION_COMMAND_KEY_ABOUT = "save-workflow-as-command";

	private static final String NAME_ABOUT = "Save Workflow As";
	...
	private static final String SHORT_DESCRIPTION_ABOUT = "Save Workflow As";

	private static final String LONG_DESCRIPTION_ABOUT = "Save Workflow As";
