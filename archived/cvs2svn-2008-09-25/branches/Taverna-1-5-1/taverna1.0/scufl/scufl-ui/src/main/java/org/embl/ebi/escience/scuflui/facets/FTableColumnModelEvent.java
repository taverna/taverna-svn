 ...
 */
public class FTableColumnModelEvent extends java.util.EventObject {
	...
	public FTableColumnModelEvent(Object source, int fromIndex, int toIndex,
	...
	public String toString() {
		return super.toString() + " fromIndex: " + fromIndex + " toIndex: "
				+ toIndex + " cause: " + cause;
	}
}
