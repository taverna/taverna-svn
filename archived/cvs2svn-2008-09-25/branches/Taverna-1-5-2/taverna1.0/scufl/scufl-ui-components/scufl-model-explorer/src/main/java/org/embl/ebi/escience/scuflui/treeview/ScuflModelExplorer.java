 ...
 * components of a ScuflModel instance.
 * 
 * @author Tom Oinn
 */
public class ScuflModelExplorer extends JTree implements
	...
	// FIXME Move to general class, and join with ScavengerTreePanel.expandAll
	...
	public void attachToModel(ScuflModel theModel) {
		if (theModel != this.model && this.model != null) {
			detachFromModel();
		}
		this.model = theModel;
