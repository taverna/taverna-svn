...
/**
 * Manages classloaders for the various plugin systems
 * to ensure class isolation (and also to remove the need
 * to specify every class on the command line which was 
...
public class PluginManager {
	...
	try {
	    ...
	    if (coreFile == null ||
		commonFile == null) {
		System.out.println("Unable to locate core and common locations, aborting.");
		return;
	    }
	    ...
	    if (pluginRoot == null) {
		System.out.println("Unable to locate plugin location, aborting.");
		return;
	    }
