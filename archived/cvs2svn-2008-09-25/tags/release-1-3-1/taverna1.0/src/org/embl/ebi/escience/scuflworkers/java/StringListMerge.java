...
/**
 * Consumes a string list and optional seperator character
 * and emits a string formed from the concatenation of all
 * items in the list with the seperator (default newline)
