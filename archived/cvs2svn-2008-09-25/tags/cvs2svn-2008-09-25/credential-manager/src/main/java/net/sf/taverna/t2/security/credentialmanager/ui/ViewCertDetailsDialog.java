...
{ 	
     ...
     * @param urlList List of serviceURLs associated with this entry
     * @throws CMException A problem was encountered getting the
     * certificate's details
     */
    public ViewCertDetailsDialog(JFrame parent, String sTitle, boolean bModal,
        X509Certificate crt, Vector<String> urlList)
        throws CMException
    {
     ...
     * certificate's details
     */
    public ViewCertDetailsDialog(JDialog parent, String sTitle, boolean bModal,
        X509Certificate crt, Vector<String> urlList)
        throws CMException
    {
        super(parent, sTitle, bModal);
        ...
        throws CMException
    {
        ...
        String sOrg = CMX509Util.getO();
        String sOU = CMX509Util.getOU();
        ...
        String iOrg = CMX509Util.getO();
        String iOU = CMX509Util.getOU();   	
        // Common Name (CN)
