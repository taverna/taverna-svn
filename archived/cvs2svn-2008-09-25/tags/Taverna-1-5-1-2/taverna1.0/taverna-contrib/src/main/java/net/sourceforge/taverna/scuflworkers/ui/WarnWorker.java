 ...
 * with interactive workflows that are being run from Taverna. Server-side or
 * command-line workflows should not use this processor.
 * 
 * @author Mark
 ...
 * 
 * @tavinput answer The response from the user. This is a dummy value since no
 *           response is allowed from the user.
 */
public class WarnWorker extends AskWorker implements LocalWorker {
	...
	public Map execute(Map inputMap) throws TaskExecutionException {
		...
		JOptionPane.showMessageDialog(null, inAdapter.getString("message"), inAdapter.getString("title"),
