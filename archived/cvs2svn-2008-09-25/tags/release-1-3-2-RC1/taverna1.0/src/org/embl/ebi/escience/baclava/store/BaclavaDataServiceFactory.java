...
/*
 * Factory class for creating instances of BaclavaDataService according to the property taverna.datastore.class, if set.
 */
...
public class BaclavaDataServiceFactory 
{
	...
	/*
	 * Returns an instance of BaclavaDataService, according to the property taverna.datastore.class
	 * returns null if this property is not set, or if there is a problem creating the store
	 */
