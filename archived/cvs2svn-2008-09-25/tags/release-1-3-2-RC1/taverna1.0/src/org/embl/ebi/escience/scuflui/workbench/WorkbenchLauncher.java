...
/**
 * Bootstrap launcher to avoid having to set an insanely long
 * classpath.
 * @author Tom Oinn
 */
public class WorkbenchLauncher {
	...
	URLClassLoader loader = new URLClassLoader(urls, WorkbenchLauncher.class.getClassLoader());
	LOADER = loader;
	Class workbenchClass = loader.loadClass("org.embl.ebi.escience.scuflui.workbench.Workbench");
	Method mainMethod = workbenchClass.getDeclaredMethod("main",new Class[]{String[].class});
	Thread.currentThread().setContextClassLoader(loader);
	Class xercesClass = loader.loadClass("org.apache.xerces.parsers.SAXParser");
