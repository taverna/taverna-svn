...
public class PlaygroundPickSupport extends ShapePickSupport {
	...
	/** 
	 * 
	 * Code extracted from ShapePickSupport with Slight modification to be able to specifiy
	 * a vertex which isn't included in the getVertex() allowing for example dragging vertex A
	 * over to Vertex B and finding Vertex B rather than constantly finding Vertex A because
	 * it is being dragged!
	 * 
	 * 
     ...
     * the vertex whose center is closest to the pick point. Ignores the Vertex passed
     * as the argument.
