...
public abstract class AbstractNCBIWorker implements LocalWorker {
	...
	private static Logger logger = Logger.getLogger(AbstractNCBIWorker.class);
	 ...
	 * 
	 * @param inputMap
	 *            A map of values to be used by the worker class.
	 */
	...
	/**
	 * This method returns an array of output value names. These values are used
	 * as keys in the outputMap.
	 */
