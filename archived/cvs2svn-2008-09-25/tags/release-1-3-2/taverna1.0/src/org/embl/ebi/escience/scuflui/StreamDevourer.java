...
/**
 * Devours an input stream and allows the contents to be read
 * as a String once the stream has completed.
 * @author Tom Oinn
 */
public class StreamDevourer extends Thread {
     ...
     * of its contents (this is equivalent to doing a join then calling toString)
     */
     ...
     * into a ByteArrayOutputStream via a BufferedReader. Because of the
     * use of the BufferedReader this is only really appropriate for
     * streams of textual data
     */
    public void run() {
	try {
	    String line = null;
