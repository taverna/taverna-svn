...
/**
 * This interface describes the methods needed by a Stream Transmitter.  This type of
 * class can transmit values to an endpoint (such as a servlet or JSP page) and 
 * process the results via a StreamProcessor.
 * 
...
public interface StreamTransmitter {
     ...
     * @param map   A map object (either HashTable or HashMap) containing the
     ...
     * @param serviceName  The name of the service for the url.
     */
     ...
     * @param context   The following portion of the url: http://host:port/context
     */
