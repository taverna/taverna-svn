...
public class XScuflParserTest {
	...
	URL location = loader.getResource("org/embl/ebi/escience/scufl/parser/test/example_sink_source.xml");
	...
	location = loader.getResource("org/embl/ebi/escience/scufl/parser/test/example_sink_source.xml");
	System.out.println("Loading definition from : "+location.toString());
