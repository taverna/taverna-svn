...
public class InfernoXMLHandler implements XMLHandler {
	...
	public Processor loadProcessorFromXML(Element processorNode,
		...
		Element infernoProcessor = processorNode.getChild("inferno",
				XScufl.XScuflNS);
		String host = infernoProcessor.getChild("host", XScufl.XScuflNS)
				.getTextTrim();
		String service = infernoProcessor.getChild("service", XScufl.XScuflNS)
				.getTextTrim();
		int port = Integer.parseInt(infernoProcessor.getChild("port",
