...
public abstract class AbstractRepository implements Repository {
     ...
     *      java.io.File)
     */
    public abstract void publish(FileObject[] filelist, FileObject startingDir)
     ...
     * @return
     */
    public FileObject[] getFileList(FileObject startingDir,
            FileSelector selector, boolean searchRecursively) {
     ...
     */
    public FileObject[] searchByFileName(FileObject startingDir, String regex,
            boolean srchRecursively) {
        FileObject[] filelist = null;
        filelist = this.getFileList(startingDir, new RegexFileSelector(regex,
                srchRecursively), srchRecursively);
        return filelist;
    }
     ...
     *      java.lang.String, boolean)
     */
    public FileObject[] searchByWorkFlowDescription(FileObject startingDir,
            String regex, boolean srchRecursively) {
        FileObject[] filelist = null;
        filelist = this.getFileList(startingDir, new XPathFileSelector(
                "//description"), srchRecursively);
        return filelist;
    }
     ...
     *      java.lang.String, boolean)
     */
    public FileObject[] searchByWorkFlowAuthor(FileObject root,
            String authorName, boolean srchRecursively) {
        FileObject[] filelist = null;
        filelist = this.getFileList(root, new XPathFileSelector("//author",
                srchRecursively), srchRecursively);
        return filelist;
    }
