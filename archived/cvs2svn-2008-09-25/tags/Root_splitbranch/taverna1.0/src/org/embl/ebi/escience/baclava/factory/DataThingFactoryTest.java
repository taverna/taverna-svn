...
public class DataThingFactoryTest {
	...
	public static void main(String[] args) {
		try {
			...
			print(new DataThing(DataThingFactory.bake(theStringArray)
					.getElement()));
			...
			theDataThing.getMetadataForObject(theXMLString, true).addMIMEType(
					"text/xml");
			print(theDataThing);
			...
			theDataThing.setLSID(theDataThing.getDataObject(),
					"LSID:theStringArrayThing");
