 ...
 * and detach from an instance of a ScuflModel. Any class implementing this
 * interface must be a subclass of JComponent; unfortunately there's no way that
 * I know of to enforce this constraint in the language, but if you don't stick
 * to it your components won't work.
 * 
 * @author Tom Oinn
 */
