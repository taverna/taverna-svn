...
public class BiomobyParserTaskTest {
	// TODO - really should check for all the individual values in the xml
	// rather than print them out
	...
	public void testObject() {
		...
		for (String key : outputs.keySet()) {
			...
			assertTrue(list.contains("EntrezGene_ID") || list.contains("7422"));
	...
	public void testObjectCollection() {
		...
		// populate the inptus
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(
				objectCollectionXML));
	...
	public void testObjectList() {
		...
		holder.add(objectXML.replaceAll("7422", "2").replaceAll(
				"EntrezGene_ID", "EG1"));
		holder.add(objectXML.replaceAll("7422", "3").replaceAll(
				"EntrezGene_ID", "EG2"));
		holder.add(objectXML.replaceAll("7422", "4").replaceAll(
				"EntrezGene_ID", "EG3"));
	...
	public void testObjectCollectionList() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(objectCollectionXML.replaceAll("EG", "EntrezGene_ID_a_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		holder.add(objectCollectionXML.replaceAll("EG", "EntrezGene_ID_b_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		holder.add(objectCollectionXML.replaceAll("EG", "EntrezGene_ID_c_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(holder));
	...
	public void testObjectListMIM() {
		...
		holder.add(objectXMLMIM.replaceAll("7422", "2").replaceAll(
				"EntrezGene_ID", "EG1"));
		holder.add(objectXMLMIM.replaceAll("7422", "3").replaceAll(
				"EntrezGene_ID", "EG2"));
		holder.add(objectXMLMIM.replaceAll("7422", "4").replaceAll(
				"EntrezGene_ID", "EG3"));
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(holder));
	...
	public void testObjectCollectionListMIM() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(objectCollectionXMLMIM.replaceAll("EG", "EntrezGene_ID_a_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		holder.add(objectCollectionXMLMIM.replaceAll("EG", "EntrezGene_ID_b_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		holder.add(objectCollectionXMLMIM.replaceAll("EG", "EntrezGene_ID_c_")
				.replaceAll("222", "b").replaceAll("333", "c"));
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(holder));
	...
	public void testPrimitiveStringCollectionList() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(stringCollectionXML.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_a_").replaceAll("111", "a").replaceAll("222",
				"b").replaceAll("333", "c"));
		holder.add(stringCollectionXML.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_b_").replaceAll("111", "i").replaceAll("222",
				"ii").replaceAll("333", "iii"));
		holder.add(stringCollectionXML.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_c_").replaceAll("111", "one").replaceAll("222",
				"two").replaceAll("333", "three"));
		holder.add(stringCollectionXML.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_d_").replaceAll("111", "uno").replaceAll("222",
				"dos").replaceAll("333", "tres"));
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(holder));
	...
	public void testPrimitiveStringList() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(stringXML.replaceAll("7422", "1").replaceAll(
				"EntrezGene_ID", "EG1").replaceAll("this is the string",
				"this is the first string"));
		holder.add(stringXML.replaceAll("7422", "2").replaceAll(
				"EntrezGene_ID", "EG2").replaceAll("this is the string",
				"this is the second string"));
		holder.add(stringXML.replaceAll("7422", "3").replaceAll(
				"EntrezGene_ID", "EG3").replaceAll("this is the string",
				"this is the third string"));
		holder.add(stringXML.replaceAll("7422", "4").replaceAll(
				"EntrezGene_ID", "EG4").replaceAll("this is the string",
	...
	public void testPrimitiveStringCollectionListMIM() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(stringCollectionXMLMIM.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_a_").replaceAll("111", "a").replaceAll("222",
				"b").replaceAll("333", "c"));
		holder.add(stringCollectionXMLMIM.replaceAll("EntrezGene_ID",
				"EntrezGene_ID_b_").replaceAll("111", "i").replaceAll("222",
	...
	public void testPrimitiveStringListMIM() {
		...
		// populate the inptus
		ArrayList<String> holder = new ArrayList<String>();
		holder.add(stringXMLMIM.replaceAll("7422", "1").replaceAll(
				"EntrezGene_ID", "EG1").replaceAll("this is the string",
				"this is the first string"));
		holder.add(stringXMLMIM.replaceAll("7422", "2").replaceAll(
				"EntrezGene_ID", "EG2").replaceAll("this is the string",
				"this is the second string"));
		holder.add(stringXMLMIM.replaceAll("7422", "3").replaceAll(
				"EntrezGene_ID", "EG3").replaceAll("this is the string",
				"this is the third string"));
		holder.add(stringXMLMIM.replaceAll("7422", "4").replaceAll(
				"EntrezGene_ID", "EG4").replaceAll("this is the string",
				"this is the fourth string"));
		inputs.put(p.getInputPorts()[0].getName(), new DataThing(holder));
	...
	private String stringXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
	...
	private String stringCollectionXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
	...
	private String objectXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
	...
	private String objectCollectionXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
	...
	private String goTermCollectionXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
	...
	private String goTermXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			...
			+ "    </moby:mobyData>" + "  </moby:mobyContent>" + "</moby:MOBY>"
			+ "";

	private String stringXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Simple moby:articleName=\"myString\">"
	...
	private String stringCollectionXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Collection moby:articleName=\"myString\">"
	...
	private String objectXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Simple moby:articleName=\"myObject\">"
	...
	private String objectCollectionXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Collection moby:articleName=\"myObject\">"
	...
	private String goTermCollectionXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Collection moby:articleName=\"terms\">"
	...
	private String goTermXMLMIM = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			+ "<moby:MOBY xmlns:moby=\"http://www.biomoby.org/moby\">"
			+ "  <moby:mobyContent>"
			+ "    <moby:mobyData moby:queryID=\"sip_1_\">"
			+ "      <moby:Simple moby:articleName=\"terms\">"
