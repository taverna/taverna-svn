 ...
 * -----------------------
 * Filename           $RCSfile: TavernaFetaGUIFactory.java,v $
 * Revision           $Revision: 1.1 $
 * Release status     $State: Exp $
 * Last modified on   $Date: 2007-12-14 12:47:41 $
 *               by   $Author: stain $
...
public class TavernaFetaGUIFactory implements UIComponentFactorySPI {

	public UIComponentSPI getComponent() {
		return TavernaFetaGUI.getInstance();
	}
