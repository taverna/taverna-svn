...
public final class PropertyInterpolator {
	 ...
	 *             properties
	 */
	public static String doInterpolate(String sourceString) {
		return doInterpolate(sourceString, System.getProperties());
	}
	 ...
	 *             properties object
	 */
	public static String doInterpolate(String sourceString, Properties props) {
