...
public class ProxyDriverManager {
	...
	private static String proxyHelperClassName = "net.sf.taverna.t2.platform.spring.jdbc.ProxyHelper";
	 ...
	 */
	public static ProxyDriverManager registerDriver(Raven repository,
			ArtifactIdentifier driverArtifact, String driverClassName) {
		// First obtain the appropriate artifact...
		try {
			ClassLoader artifactLoader = repository.getLoader(driverArtifact,
					repository.getDefaultRepositoryList());
