...
public class ProcessorXMLSerializer extends AbstractXMLSerializer {
	...
	protected Element processorToXML(Processor processor, PluginManager manager)
		...
		for (Activity<?> activity : processor.getActivityList()) {
			activities.addContent(activityToXML(activity, manager));
		}
	...
	protected Element activityToXML(Activity<?> activity, PluginManager manager)
