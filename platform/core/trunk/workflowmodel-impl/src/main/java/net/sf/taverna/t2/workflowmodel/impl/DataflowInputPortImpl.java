...
public class DataflowInputPortImpl extends AbstractEventHandlingInputPort
	...
	private DataflowInputPortHandler handler = null;

	private Dataflow dataflow;

	public void setHandler(DataflowInputPortHandler handler) {
	...
	public void receiveEvent(WorkflowDataToken t) {
		...
		if (handler != null) {
			handler.inputTokenReceived(t);
		}
		WorkflowDataToken transformedToken = t.pushOwningProcess(dataflow
				.getLocalName());
