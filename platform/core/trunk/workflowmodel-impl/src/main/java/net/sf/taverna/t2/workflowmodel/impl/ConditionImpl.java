...
public class ConditionImpl extends AbstractAnnotatedThing<Condition> implements
		Condition {

	private ProcessorImpl control, target;

	private Map<ProcessIdentifier, Boolean> stateMap = new HashMap<ProcessIdentifier, Boolean>();
	...
	public boolean isSatisfied(ProcessIdentifier owningProcess) {
	...
	protected void satisfy(ProcessIdentifier enclosingProcess) {
		stateMap.put(enclosingProcess, Boolean.TRUE);
