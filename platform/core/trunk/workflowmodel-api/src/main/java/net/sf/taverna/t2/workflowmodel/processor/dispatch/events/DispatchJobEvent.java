...
public class DispatchJobEvent extends AbstractDispatchEvent<DispatchJobEvent> {
	 ...
	 * @param activities
	 */
	public DispatchJobEvent(ProcessIdentifier owningProcess, int[] index,
	...
	public DispatchJobEvent popOwningProcess()
		...
		return new DispatchJobEvent(owner.getParent(), index, context, dataMap,
				activities);
	}
	...
	public DispatchJobEvent pushOwningProcess(String localProcessName)
			throws ProcessIdentifierException {
		return new DispatchJobEvent(owner.createChild(localProcessName), index,
