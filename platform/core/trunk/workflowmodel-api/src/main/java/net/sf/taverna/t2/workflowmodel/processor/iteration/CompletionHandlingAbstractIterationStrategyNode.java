...
public abstract class CompletionHandlingAbstractIterationStrategyNode extends
	...
	private Map<ProcessIdentifier, CompletionState> ownerToCompletion = new HashMap<ProcessIdentifier, CompletionState>();
	 ...
	 * @param owningProcess
	 */
	protected abstract void cleanUp(ProcessIdentifier owningProcess);

	private void pingCompletionState(int inputIndex,
			ProcessIdentifier owningProcess, boolean isCompletion,
	...
	private CompletionState getCompletionState(ProcessIdentifier owningProcess) {
		synchronized (ownerToCompletion) {
