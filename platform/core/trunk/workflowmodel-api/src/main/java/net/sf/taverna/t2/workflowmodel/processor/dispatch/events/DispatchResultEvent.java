...
public class DispatchResultEvent extends
	 ...
	 * @param streaming
	 */
	public DispatchResultEvent(ProcessIdentifier owner, int[] index,
	...
	public DispatchResultEvent popOwningProcess()
		...
		return new DispatchResultEvent(owner.getParent(), index, context,
				dataMap, streaming);
	}
	...
	public DispatchResultEvent pushOwningProcess(String localProcessName)
			throws ProcessIdentifierException {
		return new DispatchResultEvent(owner.createChild(localProcessName),
				index, context, dataMap, streaming);
	}
