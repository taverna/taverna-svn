...
/**
 * Abstract superclass for asynchronous activities. Activity providers should
 * only have to implement the configuration and invocation methods to have a
 * fully functional activity - serialisation and deserialisation are handled
 * automatically.
 * 
 * @author Tom Oinn
 * 
...
public abstract class AbstractAsynchronousActivity<ConfigType> extends
		AbstractActivity<ConfigType> implements
	 ...
	 * This bean should contain enough information to rebuild the input and
	 * output port sets, mappings are explicitly handled by the serialisation
	 * framework but the ports are assumed to be generated during the
	 * configuration stage rather than explicitly stored.
	 */
	@Override
