 ...
 * 
 */
public interface DispatchLayer<ConfigurationType, LayerStateType> {
	...
	public void receiveJobQueue(DispatchJobQueueEvent queueEvent,
			DispatchLayerCallback callback, LayerStateType stateModel);
	...
	/**
	 * Used to define the state scoping model for this layer implementation
	 */
	public DispatchLayerStateScoping getStateScope();

	/**
	 * Create a new instance of the layer state model, this can return null if,
	 * and only if, the state model is set to NONE. The processor that contains
	 * your dispatch layer is provided here, most layer states won't need this
	 * but it's useful for those that are collating per-process information and
	 * contributing it to the monitorable property set of the processor.
	 */
	public LayerStateType createNewStateModel(Processor parentProcessor);
