...
public class DispatchErrorEvent extends
	 ...
	 * @param t
	 */
	public DispatchErrorEvent(ProcessIdentifier owningProcess, int[] index,
	...
	public DispatchErrorEvent popOwningProcess()
		...
		return new DispatchErrorEvent(owner.getParent(), index, context,
				message, cause, failureType, failedActivity);
	}

	@Override
	public DispatchErrorEvent pushOwningProcess(String localProcessName)
			throws ProcessIdentifierException {
		return new DispatchErrorEvent(owner.createChild(localProcessName),
				index, context, message, cause, failureType, failedActivity);
	}
