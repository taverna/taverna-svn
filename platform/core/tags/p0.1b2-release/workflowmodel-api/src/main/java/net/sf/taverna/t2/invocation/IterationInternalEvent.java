...
public abstract class IterationInternalEvent<EventType extends IterationInternalEvent<?>>
	 ...
	 * @param context
	 */
	protected IterationInternalEvent(ProcessIdentifier owner, int[] index,
	 ...
	 * @return
	 */
	protected final ProcessIdentifier getPushedOwningProcess() {
		...
		return (owner.createChild(indexArrayAsString));
	}
	...
	protected final int[] getPoppedIndex() {
		String indexArrayAsString = owner.getDeepestItem();
