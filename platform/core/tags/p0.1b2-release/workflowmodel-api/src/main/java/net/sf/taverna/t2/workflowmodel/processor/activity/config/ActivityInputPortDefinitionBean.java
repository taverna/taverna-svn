...
public class ActivityInputPortDefinitionBean extends ActivityPortDefinitionBean {
	...
	private Class<?> translatedElementType = String.class;

	@SuppressWarnings("unused")
	private boolean allowsLiteralValues = true;
	...
	public void setTranslatedElementType(Class<?> newType) {
		this.translatedElementType = newType;
	}
