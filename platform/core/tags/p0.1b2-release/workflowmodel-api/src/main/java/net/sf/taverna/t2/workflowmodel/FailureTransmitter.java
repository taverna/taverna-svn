...
public interface FailureTransmitter {
	...
	/**
	 * Notify listeners that a dataflow level failure has occured
	 * 
	 * @param processIdentifier
	 * @param workflowEntity
	 * @param invocationContext
	 */
	void notifyWorkflowFailure(String processIdentifier,
			NamedWorkflowEntity workflowEntity,
			InvocationContext invocationContext);

	void addFailureListener(WorkflowInstanceListener fl);

	void removeFailureListener(WorkflowInstanceListener fl);
