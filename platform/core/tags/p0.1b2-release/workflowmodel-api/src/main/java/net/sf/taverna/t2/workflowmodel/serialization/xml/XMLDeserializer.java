...
/**
 * The API that defines the entry point for deserialising a complete dataflow
 * XML document into a dataflow instance.
 * 
 * @author Stuart Owen
 * @author Tom Oinn
 * 
...
public interface XMLDeserializer {
	 ...
	 * 
	 * @param element
	 *            an org.w3c.dom element holding the XML document that
	 *            represents the dataflow
	 * @return an instance of the Dataflow
	 * @throws DeserializationException
	 * @throws EditException -
	 *             should an error occur whilst constructing the dataflow via
	 *             Edits
	 * 
	 * @see Edits
	 */
