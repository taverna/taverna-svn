...
public class Completion extends IterationInternalEvent<Completion> {
	 ...
	 */
	public Completion(ProcessIdentifier owningProcess, int[] completionIndex,
	 ...
	 * @param owningProcess
	 */
	public Completion(ProcessIdentifier owningProcess, InvocationContext context) {
	...
	public Completion popIndex() {
		return new Completion(owner.getParent(), getPoppedIndex(), context);
	}

	@Override
	public Completion popOwningProcess() throws ProcessIdentifierException {
		return new Completion(owner.getParent(), index, context);
	}

	@Override
	public Completion pushOwningProcess(String localProcessName)
			throws ProcessIdentifierException {
		return new Completion(owner.createChild(localProcessName), index,
				context);
	}
