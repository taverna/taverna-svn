 ...
 */
public interface PropertyContributingDispatchLayer<ConfigType, StateModel>
		extends DispatchLayer<ConfigType, StateModel> {

	/**
	 * Inject properties for the specified owning process into the parent
	 * dispatch stack. Implementations of this method need to use the supplied
	 * DispatchStack reference to push properties in with the specified key.
	 * <p>
	 ...
	 * @param owningProcess
	 */
	void injectPropertiesFor(DispatchStack stack, String owningProcess,
			StateModel state);
