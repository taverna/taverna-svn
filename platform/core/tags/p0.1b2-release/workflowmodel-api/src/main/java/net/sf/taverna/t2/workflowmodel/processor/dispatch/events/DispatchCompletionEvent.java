...
public class DispatchCompletionEvent extends
	 ...
	 * @param context
	 */
	public DispatchCompletionEvent(ProcessIdentifier owner, int[] index,
	...
	public DispatchCompletionEvent popOwningProcess()
		...
		return new DispatchCompletionEvent(owner.getParent(), index, context);
	}

	@Override
	public DispatchCompletionEvent pushOwningProcess(String localProcessName)
			throws ProcessIdentifierException {
		return new DispatchCompletionEvent(owner.createChild(localProcessName),
				index, context);
	}
