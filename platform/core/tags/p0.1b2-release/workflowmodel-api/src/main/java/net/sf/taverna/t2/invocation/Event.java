...
public abstract class Event<EventType extends Event<?>> {
	...
	protected ProcessIdentifier owner;

	protected InvocationContext context;

	protected int[] index;

	protected Event(ProcessIdentifier owner, int[] index,
	...
	/**
	 * An event is active if all its parents are marked as active within the
	 * invocation context
	 */
	public final boolean isActive() {
		return context.isActive(owner);
	}
	 ...
	 */
	public final ProcessIdentifier getOwningProcess() {
		return this.owner;
	}
