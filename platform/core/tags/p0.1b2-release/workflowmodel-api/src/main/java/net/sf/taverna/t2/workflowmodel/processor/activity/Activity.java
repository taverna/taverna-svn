...
public interface Activity<ConfigurationType> extends Annotated<Activity<?>> {
	...
	/**
	 * When the Activity implementation is built from the workflow definition
	 * XML the object is first constructed with a default constructor then this
	 * method is called, passing in the configuration bean returned by
	 * getConfiguration()
	 * 
	 * @param edits
	 *            an Edits toolkit to be used when constructing new ports
	 * @throws ActivityConfigurationException
	 *             if a problem occurs when configuring the activity
	 */
	public void configure(ConfigurationType conf, Edits edits)
			throws ActivityConfigurationException;
