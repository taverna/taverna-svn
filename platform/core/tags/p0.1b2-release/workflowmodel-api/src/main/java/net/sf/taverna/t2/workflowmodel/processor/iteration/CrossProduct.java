...
public class CrossProduct extends
	...
	private Map<ProcessIdentifier, List<Set<Job>>> ownerToCache = new HashMap<ProcessIdentifier, List<Set<Job>>>();
	...
	@Override
	protected final synchronized void cleanUp(ProcessIdentifier owningProcess) {
