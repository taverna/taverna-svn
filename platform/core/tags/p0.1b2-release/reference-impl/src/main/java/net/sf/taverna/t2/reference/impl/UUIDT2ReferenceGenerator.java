...
public class UUIDT2ReferenceGenerator extends AbstractT2ReferenceGenerator
	...
	/**
	 * Create a new UUID based reference generator, this will use the namespace
	 * 'uuid' by default.
	 */
	public UUIDT2ReferenceGenerator() {
		super();
	}

	/**
	 * Create a new UUID based reference generator, uses the specified namespace
	 * for all ids
	 */
	public UUIDT2ReferenceGenerator(String namespace) {
