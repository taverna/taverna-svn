...
public class ProcessorInputPortImpl extends AbstractFilteringInputPort
	...
	@Override
	public ProcessIdentifier transformOwningProcess(ProcessIdentifier oldOwner) {
		return oldOwner.createChild(parent.getLocalName());
	}

	@Override
	protected void pushCompletion(String portName,
	...
	@Override
	protected void pushData(String portName, ProcessIdentifier owningProcess,
