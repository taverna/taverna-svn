...
public interface XMLSerializationConstants {
	...
	static final Namespace T2_WORKFLOW_NAMESPACE = Namespace
			.getNamespace("http://taverna.sf.net/2008/xml/t2flow");
	...
	static final String PLUGIN_ID = "pid";
	static final String PLUGIN_GROUP = "pgrp";
	static final String PLUGIN_VERSION = "pver";
	...
	public enum DATALINK_TYPES {
		PROCESSOR("processor"), DATAFLOW("dataflow"), MERGE("merge");
