...
/**
 * Parent configuration bean for activities that have local JAR or artifact
 * dependencies, such as API Consumer and Beanshell activity.
 * <p>
 * Removed dependencies on raven, this is currently non-functional but needs
 * fixing
 * 
 * @author Alex Nenadic
 * @author Tom Oinn
...
public class DependencyActivityConfigurationBean extends
	...
	private LinkedHashSet artifactDependencies;

	/**
	 * Local dependencies, i.e. filenames of JARs the activity depends on. The
	 * files should be present in
	 * {@link AbstractAsynchronousActivityWithDependencies#libDir}, and the
	 * paths should be relative.
	 */
	private LinkedHashSet<String> localDependencies;// = new
	...
	public DependencyActivityConfigurationBean() {
		...
		artifactDependencies = new LinkedHashSet();
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public LinkedHashSet getArtifactDependencies() {
		return new LinkedHashSet();
	}

	/**
	 * @param artifactDependencies
	 *            the artifactDependencies to set
	 */
	@SuppressWarnings("unchecked")
	public void setArtifactDependencies(LinkedHashSet artifactDependencies) {
	}
