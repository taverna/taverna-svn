...
public class RshellActivityHealthCheckerTest {
	...
	public void testCanHandle() {
		...
		assertFalse(activityHealthChecker.canHandle(new AbstractActivity<Object>() {
			public void configure(Object conf, Edits edits) throws ActivityConfigurationException {
			}
	...
	public void testCheckHealth() {
		HealthReport healthReport = activityHealthChecker.checkHealth(activity, new ArrayList<HealthChecker<?>>());
